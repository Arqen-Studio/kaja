    ...
    <div className="min-h-screen flex flex-col items-center justify-center">
      ...
      <div className="w-full mb-25">
        ...
        <div className="w-full overflow-hidden">
          ...
          <div
            className="flex md:grid md:grid-cols-2 gap-6 md:gap-10 md:px-[8vw] overflow-x-auto md:overflow-visible snap-x snap-mandatory pb-4 md:pb-0 [&::-webkit-scrollbar]:hidden"
          ...
          >
            ...
            <div className="flex-shrink-0 snap-start md:!w-auto md:justify-self-start" style={{ width: "clamp(260px, 41vw, 600px)" }}>
              <img
                src="/png/raw.png"
                alt="raw"
            ...
            <div className="flex-shrink-0 snap-start flex flex-col md:!w-auto md:justify-self-end" style={{ width: "clamp(200px, 27vw, 600px)" }}>
              <img
                src="/png/fire.png"
                alt="fire"
                className="object-cover"
