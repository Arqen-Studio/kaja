  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="relative z-10 -mt-14 flex max-h-[min(620px,80vh)] w-full max-w-[min(344px,100%)] flex-col items-center justify-center gap-4 border md:z-50"
      >
        <img
          src="/png/chef.png"
          alt="chef"
          className="h-auto w-full max-w-[344px] object-contain"
        />
