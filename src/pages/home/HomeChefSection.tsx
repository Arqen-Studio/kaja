  ...
  return (
    ...
    >
      <motion.h1
        ...
        className="hidden md:block max-w-full px-1 py-6 text-center font-moche font-extralight text-[clamp(1.5rem,6.5vw,109.5px)] leading-[1.2] tracking-[-0.028em] whitespace-nowrap md:pt-10 md:pb-0"
      >
